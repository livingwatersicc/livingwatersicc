  ...
  return (
    <Container className="p-5">
      <p>
        ...
        cisterns, broken cisterns that cannot hold water. The Word of God cannot
        be understood by mere intellectual capability (own cisterns, broken
        cisterns that cannot hold water) but by the revelation of the Holy
        Spirit (the spring of living water) to the humble (Matt 11:25).
      </p>
      ...
      <p>
        ...
        the truth it imparts will progressively sanctify and liberate us (John
